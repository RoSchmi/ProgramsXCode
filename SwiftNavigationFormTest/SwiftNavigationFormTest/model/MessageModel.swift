...
class MessageModel: ObservableObject {	@Published var messagesByTopic: [String: MessagesByTopic] {
		didSet {
			updateDisplayTopics()
		}
	}
	...
	func sortedTopicsByFilter(filter: String?) -> [MessagesByTopic] {
		...
		*/
		return values.filter {
			...
			//return trimmed == nil || trimmed!.isBlank ||
            return trimmed == nil ||             $0.topic.name.localizedCaseInsensitiveContains(trimmed!)
		}
	}
